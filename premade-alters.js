...
class PremadeAltersManager {
  constructor() {
    ...
    this.premadeAlters = {
      ...
      "2": {
        ...
        category: "business",
        image: "https://readdy.ai/api/search-image?query=professional%2520looking%2520digital%2520avatar%2520of%2520business%2520coach%2520man%2520on%2520dark%2520background%2520high%2520quality%2520realistic%25203D%2520render%2520with%2520perfect%2520lighting%2520and%2520textures&width=400&height=400&seq=14&orientation=squarish",
        voiceId: "EXAVITQu4vr4xnSDxMaL",
        voiceName: "Bella",
  ...
  async loadAlters() {
    try {
      // Use the hardcoded premade alters instead of fetching from API
      const data = Object.values(this.premadeAlters);
  ...
  getAlterById(id) {
    ...
    return this.alters.find(alter => alter.id === `premade_${cleanId}` || alter.id === cleanId);
  }
